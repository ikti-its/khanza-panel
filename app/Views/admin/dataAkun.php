                                ...
                                <?php foreach ($akun_data as $akunEntry) : ?>
                                    <tr>
                                        ...
                                        <td class="h-px w-72 whitespace-nowrap">
                                            <div class="px-6 py-3">
                                                <span class="block text-sm font-semibold text-gray-800 dark:text-gray-200"><?= $akunEntry['email'] ?? 'N/A' ?></span>
                                            </div>
                                        </td>

                                        <td class="h-px w-72 whitespace-nowrap">
                                            <div class="px-6 py-3">
                                                <span class="block text-sm font-semibold text-gray-800 dark:text-gray-200"><?= $akunEntry['id'] ?? 'N/A' ?></span>
                                            </div>
                                        </td>
                                        ...
                                        <td class="size-px whitespace-nowrap">
                                            <div class="px-6 py-1.5">
                                                <a  href ="/hapusakun/<?= $akunEntry['id'] ?>"class="inline-flex items-center gap-x-1 text-sm text-red-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#">
                                                    Delete
                                                </a>
                                            </div>
                                        </td>
