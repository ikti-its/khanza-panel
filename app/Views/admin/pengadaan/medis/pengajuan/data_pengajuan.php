                    ...
                    <div class="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 dark:border-gray-700">
                        <div>
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400">
                                Add Pengajuan Barang Medis, edit and more.
                            </p>
                        </div>
                                            ...
                                            <div class="p-4 overflow-y-auto">
                                                <div class="space-y-4">
                                                    <div>
                                                        ...
                                                        <p><strong>Tanggal Pengajuan:</strong> <?php
                                                        ...
                                                        foreach ($pegawai_data as $pegawai) {
                                                            if ($pegawai['id'] === $pengajuan['id_pegawai']) {
                                                                echo '<p><strong>Pegawai:</strong> ' . $pegawai['nama'] . '</p>';
                                                            }
                                                        }
                                                        ?></p>
                                                        ...
                                                        <?php foreach ($persetujuan_data as $persetujuan) {
                                                            if ($persetujuan['id_pengajuan'] === $pengajuan['id']) { ?>
                                                                <p><strong>Status Persetujuan Apoteker:</strong> <?= $persetujuan['status_apoteker'] ?></p>
                                                                <p><strong>Status Persetujuan Keuangan:</strong> <?= $persetujuan['status_keuangan'] ?></p>
                                                                <p><strong>Status Pesanan:</strong> <?= $persetujuan['status'] ?></p>
                                                        <?php }
                                                        } ?>
                                                    </div>
                                                            ...
                                                            <?php foreach ($pesanan_data as $pesanan) {
                                                                if ($pesanan['id_pengajuan'] === $pengajuan['id']) { ?>
                                                                    <span class="flex justify-between">
                                                                        <span> <?php
                                                                                foreach ($barang_medis_data as $barang_medis) {
                                                                                    if ($barang_medis['id'] === $pesanan['id_barang_medis']) {
                                                                                        echo $barang_medis['nama'];
                                                                                    }
                                                                                }
                                                                                ?><br><small>Jumlah: <?= $pesanan['jumlah_pesanan'] . " "; ?><?php
                                    ...
                                    <td class="h-px w-72 whitespace-nowrap">
                                        <div class="px-6 py-3">
                                            <span class="block text-sm font-semibold text-gray-800 dark:text-gray-200">
                                                <a href="#" class="pengajuan-link hover:underline" data-hs-overlay="#hs-vertically-centered-scrollable-modal-<?= $pengajuan['id'] ?>" data-id="<?= $pengajuan['id'] ?>">
                                        ...
                                        <div class="px-6 py-3">
                                            ...
                                            switch ($pengajuan['status_pesanan']) {
                                                ...
                                                case '1':
                                                    ...
                                                    break;
                                                case '2':
                                                    echo '<span class="py-1 px-1.5 inline-flex items-center gap-x-1 text-xs font-medium bg-green-200 text-white rounded-full dark:bg-teal-500/10 dark:text-teal-500">
                                                            <svg class="size-2.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                                                                <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z" />
                                                            </svg>
                                                            Pengajuan Disetujui
...
<!-- End Table Section -->
<script>
    function closeModal(pengajuanId) {
        var modalId = "hs-vertically-centered-scrollable-modal-" + pengajuanId;
