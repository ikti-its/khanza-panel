...
<!-- 
                                        ...
                                        <td class="h-px w-48 whitespace-nowrap">
                                            <div class="ps-6 py-3">
                                                ...
                                                <span class="block text-sm font-semibold text-gray-800 dark:text-gray-200 hover:underline"><?= $jadwalEntry['nama'] ?? 'N/A' ?></span>
                                                </a>
                    ...
                    <div class="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-t border-gray-200 dark:border-gray-700">
                        ...
                        <nav class="flex items-center gap-x-1">
                            <?php if ($meta_data['page'] > 1) : ?>
                                <a href="/jadwalpegawai?page=<?= $meta_data['page'] - 1 ?>&size=10" class="min-h-[38px] min-w-[38px] py-2 px-2.5 inline-flex justify-center items-center gap-x-2 text-sm rounded-lg text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:text-white dark:hover:bg-white/10 dark:focus:bg-white/10">
