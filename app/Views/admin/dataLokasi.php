    ...
    <div class="overflow overflow-x-auto px-4 py-10 sm:px-6 lg:px-8 mx-auto"><!-- Card -->
        ...
        <form action="/submiteditlokasi/<?= $lokasi_data['id'] ?? '' ?>" method="post">
            ...
            <div class="grid sm:grid-cols-12 gap-2 sm:gap-6">
                ...
                <!-- End Col -->
                <div class="sm:col-span-3">
                    <label for="af-account-radius" class="inline-block text-sm text-gray-800 mt-2.5 dark:text-neutral-200">
                        Radius
                    </label>
                </div>
                <!-- End Col -->
                <div class="sm:col-span-9">
                    <input id="af-account-radius" type="text" name="radiusz" class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:outline-teal-500 focus:ring-teal-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" value="<?= $lokasi_data['radius'] ?? '' ?>">
                </div>
