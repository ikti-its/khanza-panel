            ...
            <div class=" py-4 mx-6 flex justify-between items-center border-b border-gray-200 dark:border-neutral-700">
                ...
                <div class="grid sm:grid-cols-12 gap-2 sm:gap-6">
                    ...
                    <div class="sm:col-span-9">
                        <input id="af-account-id" name="id" type="text" class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:outline-teal-500 focus:ring-blue-500" value="<?= $jadwalData['id'] ?>">
                    </div>
                    <!-- End Col -->
                    ...
                    <div class="sm:col-span-9">
                        <input id="af-account-id-pegawai" name="id_pegawai" type="text" class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:outline-teal-500 focus:ring-blue-500" value="<?= $jadwalData['id_pegawai'] ?>">
                    </div>
                    <!-- End Col -->
