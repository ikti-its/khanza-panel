            ...
            if ($response_medis) {
                ...
                if ($http_status_code_medis === 200) {
                    ...
                    foreach ($jenis_url as $jenis => $url) {
                        // if ($medis['jenis'] === 'Obat') {
                        //     $jenis_url = $this->api_url . '/inventaris/obat';
                        // } elseif ($medis['jenis'] === 'Alat Kesehatan') {
                        //     $jenis_url = $this->api_url . '/inventaris/alkes';
                        // } elseif ($medis['jenis'] === 'Bahan Habis Pakai') {
                        //     $jenis_url = $this->api_url . '/inventaris/bhp';
                        // } elseif ($medis['jenis'] === 'Darah') {
                        //     $jenis_url = $this->api_url . '/inventaris/darah';
                        // } else {
